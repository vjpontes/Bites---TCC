  ...
  <body >
   ...
   <div class="header-area">
    ...
    <div class="slider-area">
        <h2 style="text-align: center; margin-top: 40px">Valores</h2>

        <div class="card-deck" style="margin-top: 40px">
          <div class="card">
            <img style="height: 250px" src="img/etica.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Ética</h5>
              <p class="card-text">Relações baseadas em honestidade e respeito, fidelidade aos nossos clientes e comprometimento aos serviços oferecidos.</p>

            </div>
          </div>
          <div class="card">
            <img style="height: 250px" src="img/inovaçao.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Inovação</h5>
              <p class="card-text">Compromisados a buscar sempre as mais novas e modernas tecnologias.</p>

            </div>
          </div>
          <div class="card">
            <img style="height: 250px" src="img/eficiencia.jpg" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Eficiência</h5>
              <p class="card-text">Eficácia na prestação dos serviços, desistir não é uma opção.</p>
