<?php
   ...
   $sqlinsert = "UPDATE cadacessorios SET produto = '$produto', preco = '$preco', img = '$img' WHERE id_produto = $id_produto";
   ...
   echo "<script> alert('Dados editados com sucesso!!!') </script>
        <meta http-equiv='refresh' content=0.1;url='listaracessorios.php'>";
